data_measurement(1, 1, :) = sensor1x(2:25, 1);
data_measurement(1, 2, :) = sensor1y(2:25, 1);
data_measurement(2, 1, :) = sensor2x(2:25, 1);
data_measurement(2, 2, :) = sensor2y(2:25, 1);


for i = 1:5
    data_measurement(2, 1, i) = sensor2x(7,1);
    data_measurement(2, 2, i) = sensor2y(7,1);
end;
...
target_position=[sensor1x(2,1) sensor1y(2,1) (sensor1x(3,1) - sensor1x(2,1)) (sensor1y(3,1) - sensor1y(2,1)); 
                 sensor2x(7,1) sensor2y(7,1) (sensor2x(8,1) - sensor2x(7,1)) (sensor2y(8,1) - sensor2y(7,1))]; 
...
legend('Sensor Data 1', 'Sensor Data 2', ...
