data_measurement(1, 1, :) = sensor1x(1:100, 1);
data_measurement(1, 2, :) = sensor1y(1:100, 1);
data_measurement(2, 1, :) = sensor2x(1:100, 1);
data_measurement(2, 2, :) = sensor2y(1:100, 1);
...
target_position=[sensor1x(1, 1) sensor1x(2,1) - sensor1x(1,1) sensor1y(1, 1) sensor1y(2,1) - sensor1y(1,1);
                 sensor2x(1, 1) sensor2x(2,1) - sensor2x(1,1) sensor2y(1, 1) sensor2y(2,1) - sensor2y(1,1)];
